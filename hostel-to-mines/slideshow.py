"""
Hostel to Mines – 12-image slideshow (dream, wake, rejections, farm, save, rigging course, license, mines).
Optional music. Run from this directory.
"""
...
OUTPUT = Path(__file__).resolve().parent / "hostel_to_mines_slideshow.mp4"
...
DURATION_PER_IMAGE = 4  # 12 * 4 = 48 seconds
