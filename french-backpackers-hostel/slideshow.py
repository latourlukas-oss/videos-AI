"""
French Backpackers Hostel – 4-image slideshow (eat, drink French, apply jobs, party club). Optional music.
"""
...
OUTPUT = Path(__file__).resolve().parent / "french_backpackers_hostel_slideshow.mp4"
...
DURATION_PER_IMAGE = 5  # 20 seconds total
