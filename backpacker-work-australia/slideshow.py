"""
Backpacker Work Australia – 5-image slideshow (kitchen, waiter, mangoes, tractor seeding canola, construction). Optional music.
"""
...
OUTPUT = Path(__file__).resolve().parent / "backpacker_work_australia_slideshow.mp4"
...
DURATION_PER_IMAGE = 5  # 25 seconds total
